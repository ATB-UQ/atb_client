...
class AdminUsers(Resource):
    ...
    def list(
        ...
        return (
            yield from _ops.page_of(
                self._client, dict, "admin/users", {"q": q, "limit": limit, "cursor": cursor}
            )
        )
    ...
    def update(self, user_id: Id, **fields: Any):
        ...
        return (
            yield from _ops.json_call(self._client, "PATCH", f"admin/users/{user_id}", json=fields)
        )
    ...
    def update_key(self, user_id: Id, key_id: Id, **limits: Any):
        ...
        return (
            yield from _ops.json_call(
                self._client, "PATCH", f"admin/users/{user_id}/keys/{key_id}", json=limits
            )
        )
    ...
    def revoke_key(self, user_id: Id, key_id: Id):
        ...
        return (
            yield from _ops.json_call(
                self._client, "DELETE", f"admin/users/{user_id}/keys/{key_id}"
            )
        )
...
class AdminMolecules(Resource):
    ...
    def update(self, molid: int, **fields: Any):
        ...
        return (
            yield from _ops.json_call(
                self._client, "PATCH", f"admin/molecules/{int(molid)}", json=fields
            )
        )
    ...
    def invalidate(self, molid: int):
        ...
        return (
            yield from _ops.json_call(
                self._client, "POST", f"admin/molecules/{int(molid)}:invalidate", json={}
            )
        )
    ...
    def request_scan(self, molid: int, **params: Any):
        ...
        return (
            yield from _ops.json_call(
                self._client, "POST", f"admin/molecules/{int(molid)}/scans", json=params
            )
        )
    ...
    def cancel_scan(self, molid: int, run: Id):
        ...
        return (
            yield from _ops.json_call(
                self._client, "DELETE", f"admin/molecules/{int(molid)}/scans/{run}"
            )
        )
...
class Admin(Resource):
    ...
    def quota_requests(self, *, limit: Optional[int] = None):
        ...
        return (
            yield from _ops.page_of(self._client, dict, "admin/quota-requests", {"limit": limit})
        )
    ...
    def approve_quota_request(self, request_id: Id):
        ...
        return (
            yield from _ops.json_call(
                self._client, "POST", f"admin/quota-requests/{request_id}:approve", json={}
            )
        )
    ...
    def deletion_requests(self, *, limit: Optional[int] = None):
        ...
        return (
            yield from _ops.page_of(self._client, dict, "admin/deletion-requests", {"limit": limit})
        )
